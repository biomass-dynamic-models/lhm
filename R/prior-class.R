...
#'
#' For example, values for \eqn{r} can be simulated directly or generated using the \code{\link{rCalc}} function. The class contains an additional slot to hold parameters of the log-normal distribution, which is used by \code{bdm} to describe the prior for \eqn{r}.
#' 
#' @slot .Data numeric vector of derived values
#' @slot lognormal_par log-normal distribution parameter values
#'
#' @export
setClass("prior", contains = "numeric", slots = list(lognormal_par = "list"))
